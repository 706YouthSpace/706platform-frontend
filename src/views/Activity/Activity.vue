  ...
  <div class="activity">
    ...
    <div class="activity__filters">
      <div class="activity__filter"
           ...
           :key="filter.key">
        <div class="activity__filter__label">
          {{filter.label}}
        </div>
        <div class="activity__filter__options">
          <span class="activity__filter__option"
          ...
          <span class="activity__filter__option calendar" v-if="filter.key === 'time'">
            <img src="@/assets/images/calendar.png"/><span>按日历</span>
          </span>
        </div>
      </div>
    </div>
    <div class="activity__list">
      <div class="activity__item">
        ...
        <div class="activity__item__content">
          <div class="activity__item__title">
            技术的社会面沙龙
          </div>
          <div class="activity__item__time">
            2020.05.31 19:30
          </div>
          <div class="activity__item__site">
            线上｜腾讯会议
          </div>
          <div class="activity__item__price">
            ¥ 100
          </div>
        </div>
      </div>
