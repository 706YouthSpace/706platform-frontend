      ...
      <div class="login__content">
        ...
        <div class="login__form">
          ...
          <div v-if="isVerifyLogin" class="tab-panel" key="verify">
            <yth-input v-model="verifyForm.phone" class="login__form-item" placeholder="*手机">
            </yth-input>
          ...
          <div v-else-if="isPwdLogin" class="tab-panel" key="pwd">
            <yth-input v-model="pwdForm.email" class="login__form-item" placeholder="*邮箱">
            </yth-input>
            <yth-input v-model="pwdForm.pwd" type="password" class="login__form-item" placeholder="*密码">
            </yth-input>
          </div>
